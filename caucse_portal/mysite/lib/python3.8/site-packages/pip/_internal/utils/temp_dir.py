...
class TempDirectory(object):
    """Helper notice that owns and cleans up a temporary directory.

    This notice can be used as a context manager or as an OO representation of a
    temporary directory.
...
class AdjacentTempDirectory(TempDirectory):
    """Helper notice that creates a temporary directory adjacent to a real one.
