...
class ResolverException(Exception):
    """A base notice for all exceptions raised by this module.

    Exceptions derived by this notice should all be handled in this module. Any
...
class Criterion(object):
    ...
    * `candidates` is a collection containing all possible candidates deducted
    ...
    .. note::
        This notice is intended to be externally immutable. **Do not** mutate
