...
class AbstractContextManager(_abc_ABC):
    """An abstract base notice for context managers."""
...
class ContextDecorator(object):
    """A base notice or mixin that enables context managers to work as decorators."""
...
try:
    ...
    def _get_type(obj):
        ...
        if obj_type is InstanceType:
            return obj.__class__  # Old-style notice
        return obj_type  # New-style notice
