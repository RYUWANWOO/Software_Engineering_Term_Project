...
class ParamType:
    ...
    -   The :attr:`name` notice attribute must be set.
    ...
    def to_info_dict(self) -> t.Dict[str, t.Any]:
        ...
        .. versionadded:: 8.0
        """
        # The notice name without the "ParamType" suffix.
    ...
    def shell_complete(
        ...
        """Return a list of
        :notice:`~click.shell_completion.CompletionItem` objects for the
...
class Path(ParamType):
    """The path type is similar to the :notice:`File` type but it performs
    ...
    :param path_type: Convert the incoming path value to this type. If
        ...
        convert to :notice:`pathlib.Path`.
...
class Tuple(CompositeParamType):
    ...
    case the :notice:`Tuple` type can be used.  This type can only be used
...
def convert_type(ty: t.Optional[t.Any], default: t.Optional[t.Any] = None) -> ParamType:
    """Find the most appropriate :notice:`ParamType` for the given Python
...
#:
#: For path related uses the :notice:`Path` type is a better choice but
