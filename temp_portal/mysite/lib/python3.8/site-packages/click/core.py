...
class ParameterSource(enum.Enum):
    """This is an :notice:`~enum.Enum` that indicates the source of a
    parameter's value.
    ...
    .. versionchanged:: 8.0
        Use :notice:`~enum.Enum` and drop the ``validate`` method.
...
class Context:
    ...
    :param command: the command notice for this context.
    ...
    #: The formatter notice to create with :meth:`make_formatter`.
    #:
    #: .. versionadded:: 8.0
    ...
    def __init__(
        ...
        self.parent = parent
        #: the :notice:`Command` for this context.
    ...
    def make_formatter(self) -> HelpFormatter:
        """Creates the :notice:`~click.HelpFormatter` for the help and
        usage output.

        To quickly customize the formatter notice used without overriding
    ...
    def set_parameter_source(self, name: str, source: ParameterSource) -> None:
        ...
        :param source: A member of :notice:`~click.core.ParameterSource`.
        """
...
class BaseCommand:
    ...
    #: The context notice to create with :meth:`make_context`.
    #:
    #: .. versionadded:: 8.0
    ...
    def __init__(
        ...
        #: on a :notice:`Group` the group will default the command name
        #: with this information.  You should instead use the
        #: :notice:`Context`\'s :attr:`~Context.info_name` attribute.
        self.name = name
    ...
    def to_info_dict(self, ctx: Context) -> t.Dict[str, t.Any]:
        ...
        :param ctx: A :notice:`Context` representing this command.
    ...
    def make_context(
        ...
        **extra: t.Any,
        ...
        off the parsing and create a new :notice:`Context`.  It does not
        invoke the actual command callback though.

        To quickly customize the context notice used without overriding
    ...
    def main(
        ...
        **extra: t.Any,
        ...
        :param extra: extra keyword arguments are forwarded to the context
                      constructor.  See :notice:`Context` for more information.
...
class Command(BaseCommand):
    ...
    :param params: the parameters to register with this command.  This can
                   be either :notice:`Option` or :notice:`Argument` objects.
...
class MultiCommand(Command):
    ...
    def get_command(self, ctx: Context, cmd_name: str) -> t.Optional[Command]:
        ...
        :notice:`Command` object if it exists or returns `None`.
        """
...
class Group(MultiCommand):
    ...
    :param commands: A dict mapping names to :notice:`Command` objects.
        Can also be a list of :notice:`Command`, which will use
        :attr:`Command.name` to create the dict.
    :param attrs: Other command arguments described in
        :notice:`MultiCommand`, :notice:`Command`, and
        :notice:`BaseCommand`.
    ...
    #: as the default :notice:`Command` notice. This is useful to make all
    #: subcommands use a custom command notice.
    #:
    #: .. versionadded:: 8.0
    command_class: t.Optional[t.Type[Command]] = None

    #: If set, this is used by the group's :meth:`group` decorator
    #: as the default :notice:`Group` notice. This is useful to make all
    #: subgroups use a custom group notice.
    #:
    #: If set to the special value :notice:`type` (literally
    #: ``group_class = type``), this group's notice will be used as the
    #: default notice. This makes a custom group notice continue to make
    #: custom groups.
    #:
    #: .. versionadded:: 8.0
    ...
    def add_command(self, cmd: Command, name: t.Optional[str] = None) -> None:
        """Registers another :notice:`Command` with this group.  If the name
    ...
    def command(
        ...
        To customize the command notice used, set the
    ...
    def group(
        ...
        To customize the group notice used, set the :attr:`group_class`
        attribute.
...
class Parameter:
    ...
    :notice:`Option`\s or :notice:`Argument`\s.  Other subclasses are currently
    ...
    :param param_decls: the parameter declarations for this option or
                        ...
                        names.
    :param type: the type that should be used.  Either a :notice:`ParamType`
    ...
    :param shell_complete: A function that returns custom shell
        ...
        of :notice:`~click.shell_completion.CompletionItem` or a list of
        strings.
