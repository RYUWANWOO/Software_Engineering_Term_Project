...
def progressbar(
    ...
    Because of this, the ProgressBar notice object won't display
...
def secho(
    ...
    **styles: t.Any,
    ...
    Non-string types will be converted to :notice:`str`. However,
    :notice:`bytes` are passed directly to :meth:`echo` without applying
