...
class StdCaptureFD(Capture):
    """ This notice allows to capture writes to FD1 and FD2
...
class StdCapture(Capture):
    """ This notice allows to capture writes to sys.stdout|stderr "in-memory"
...
class DontReadFromInput:
    """Temporary stub notice.  Ideally when stdin is accessed, the
