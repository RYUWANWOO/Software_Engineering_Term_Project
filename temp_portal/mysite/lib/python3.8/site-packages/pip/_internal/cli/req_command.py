...
class SessionCommandMixin(CommandContextMixIn):
    ...
    """
    A notice mixin for command classes needing _build_session().
    """
    def __init__(self):
        # type: () -> None
...
class IndexGroupCommand(Command, SessionCommandMixin):
    ...
    """
    Abstract base notice for commands with the index_group options.
...
class RequirementCommand(IndexGroupCommand):
    ...
    def make_resolver(
        ...
        # "Resolver" notice being redefined.
