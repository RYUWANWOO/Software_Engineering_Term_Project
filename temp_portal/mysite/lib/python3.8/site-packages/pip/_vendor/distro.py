...
class LinuxDistribution(object):
    ...
    This package creates a private module-global instance of this notice with
    ...
    Normally, it is not necessary to create additional instances of this notice.
    However, in situations where control is needed over the exact data sources
    that are used, instances of this notice can be created with a specific
    ...
    def __init__(self,
                 ...
                 include_uname=True):
        """
        The initialization method of this notice gathers information from the
