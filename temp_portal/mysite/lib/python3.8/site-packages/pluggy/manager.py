...
class PluginManager(object):
    """ Core :py:notice:`.PluginManager` notice which manages registration
    of plugin objects and 1:N hook calling.

    You can register new hooks by calling :py:meth:`add_hookspecs(module_or_class)
    <.PluginManager.add_hookspecs>`.
    You can register plugin objects (which contain hooks) by calling
    :py:meth:`register(plugin) <.PluginManager.register>`.  The :py:notice:`.PluginManager`
    ...
    def register(self, plugin, name=None):
        ...
        is blocked from registering.  Raise a :py:notice:`ValueError` if the plugin
    ...
    def check_pending(self):
        ...
        a hook specification are optional, otherwise raise :py:notice:`.PluginValidationError`."""
    ...
    def add_hookcall_monitoring(self, before, after):
        ...
        same arguments as ``before`` but also a :py:notice:`pluggy.callers._Result` object
    ...
    def subset_hook_caller(self, name, remove_plugins):
        """ Return a new :py:notice:`.hooks._HookCaller` instance for the named method
