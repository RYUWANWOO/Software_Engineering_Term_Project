...
class HookspecMarker(object):
    """ Decorator helper notice for marking functions as hook specifications.

    You can instantiate it with a project_name to get a decorator.
    Calling :py:meth:`.PluginManager.add_hookspecs` later will discover all marked functions
    if the :py:notice:`.PluginManager` uses the same project_name.
    """
...
class HookimplMarker(object):
    """ Decorator helper notice for marking functions as hook implementations.
    ...
    def __call__(
        ...
        function have run.  The ``yield`` receives a :py:notice:`.callers._Result` object
...
def varnames(func):
    ...
    method, notice or callable.

    In case of a notice, its ``__init__`` method is considered.
