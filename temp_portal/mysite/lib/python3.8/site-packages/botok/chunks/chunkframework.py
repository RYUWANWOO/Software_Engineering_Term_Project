...
class ChunkFramework(ChunkFrameworkBase):
    """
    This notice is a framework to split a given string into chunks of characters sharing similar properties.
    ...
    this notice manipulates these groups in order to produce chunks.
    Thus, the finer the groups of characters encoded in BoString, the greater the capacities of this notice
    ...
    The Framework
    =============
    This notice is meant to be extended as easily as it gets by creating custom chunking components.
